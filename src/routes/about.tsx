...
const tracking = [
  {
    ...
    body: "Guest journeys use one journey code for sharing and return checks, so you can see whether your partner has started, completed or expired.",
  },
  {
    icon: Timer,
  ...
  },
  {
    ...
    body: "Results stay behind the journey code or signed-in owner session. Optional report sharing is a separate, explicit action.",
  },
];
    ...
    <div className="space-y-20 pb-10">
      ...
      <section className="space-y-6">
        <SectionHeader
          ...
          sub="Start privately first. If you want to keep track, your journey code or account can bring you back."
        />
        <div className="grid md:grid-cols-2 gap-4">
          {tracking.map((t, i) => (
            <motion.div
