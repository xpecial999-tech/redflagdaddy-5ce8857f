...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dynamic Compass — Consent & Compatibility Assessment" },
      { name: "twitter:title", content: "Dynamic Compass — Consent & Compatibility Assessment" },
      { property: "og:description", content: "A consent, compatibility, safety and red-flag assessment platform for Dominants, submissives and switches." },
      { name: "twitter:description", content: "A consent, compatibility, safety and red-flag assessment platform for Dominants, submissives and switches." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7633a194-519e-4857-b6f3-ad555b2e08ad/id-preview-929e49a4--c4e62bb1-63dc-4a13-acc4-adb8c85014e1.lovable.app-1780678047849.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7633a194-519e-4857-b6f3-ad555b2e08ad/id-preview-929e49a4--c4e62bb1-63dc-4a13-acc4-adb8c85014e1.lovable.app-1780678047849.png" },
