  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass rounded-3xl p-8 max-w-md text-center">
        <img src="/favicon.png" alt="" width={64} height={64} className="mx-auto h-16 w-16" />
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Use the button below to return to RedFlagDaddy.
        </p>
        <Link
          to="/"
          className="mt-6 inline-flex min-h-11 items-center justify-center rounded-xl bg-primary px-4 py-2 text-sm font-medium text-primary-foreground"
        >
          Return home
        </Link>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass rounded-3xl p-8 max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex min-h-11 items-center rounded-xl border border-border px-4 py-2 text-sm"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "RedFlagDaddy — Structured conversations for adults" },
      {
        name: "description",
        content:
          "Private, role-aware prompts that help adults discuss consent, compatibility, boundaries and safety. Not identity verification or proof of consent.",
      },
      ...
      { property: "og:image", content: "https://redflagdaddy.com/social-preview-20260907.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:type", content: "image/png" },
      { name: "twitter:title", content: "RedFlagDaddy — Structured conversations for adults" },
      { name: "twitter:image", content: "https://redflagdaddy.com/social-preview-20260907.png" },
      {
